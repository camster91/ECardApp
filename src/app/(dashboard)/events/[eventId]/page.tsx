    ...
    <div className="py-8">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          {/* Action buttons — grid on mobile for fat-finger friendly touch targets */}
          <div className="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap">
            <Link
              href={`/events/${eventId}/edit`}
              className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 active:bg-gray-100 sm:py-2"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
function PublishButton({
  ...
  return (
    ...
    >
      <button
        type="submit"
        className={`inline-flex w-full items-center justify-center gap-1.5 rounded-xl px-4 py-3 text-sm font-medium shadow-sm transition-colors sm:w-auto sm:py-2 ${
          isPublished
